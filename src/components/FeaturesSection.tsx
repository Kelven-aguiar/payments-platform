...
export function FeaturesSection() {
	const features = [
		...
		},
		{
			...
			description:
				"Aceite pagamentos online de forma simples e segura em sua aplicação.",
			icon: (
				<svg
					className="w-6 h-6 text-primary"
					fill="currentColor"
		...
		},
		{
			...
			description:
				"Ofereça um portal personalizado para seus clientes gerenciarem pagamentos e créditos.",
			icon: (
				<svg
					className="w-6 h-6 text-primary"
					fill="currentColor"
